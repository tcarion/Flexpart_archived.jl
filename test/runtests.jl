...
# file = "/home/tcarion/CBRN-dispersion-app/public/flexpart_runs/last_best/output/parts2e6_ioutput0_nest.nc"
lon, lat = mesh(file)
dx, dy = Flexpart.deltamesh(lon, lat)
dataset = Flexpart.conc_diskarray(file)
# Flexpart.NCF_OUTPUT
